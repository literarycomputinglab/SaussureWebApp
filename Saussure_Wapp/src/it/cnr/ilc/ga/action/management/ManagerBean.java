...
//	private CommentSet commentSet;
	...
	public ManagerBean() {
		...
		/*
		 * String path="log4j.properties"; PropertyConfigurator.configure(path);
...
//			}
	...
	public synchronized boolean removeComments(double idPericope) {
		String idPericopeStr = Double.toString(idPericope);
		if (null != hashComments) {
			hashComments.put(idPericopeStr, new PericopeComments(idPericopeStr)); // TODO inserire il controllo in add
																					// comment sulla lista di
																					// pericopeComments

		} else {
			System.err.println("di lì no!");
		}
	...
	/**
	 * Individua nella lista delle pericopi la pericope con riferimento
	 * idRefPericope
	 * 
	 * @param idRefPericope
